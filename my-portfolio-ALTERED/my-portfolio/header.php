				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarText">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
							...
							<li class="nav-item">
								<a class="nav-link" href="<?php echo home_url(('/#achievements')) ?>">Certifications</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="<?php echo home_url(('/#badges')) ?>">Badges</a>
								
								<!-- Changed skills to badges -->
							</li>
							<li class="nav-item">
